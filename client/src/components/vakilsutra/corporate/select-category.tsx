...
const categories = [
  { name: "Business Entity Registration", icon: "/icons/motor.png" },
  { name: "Business Agreements", icon: "/icons/motor.png" },
  { name: "Legal & Compliance Documents", icon: "/icons/motor.png" },
  { name: "Company Closure & Dissolution", icon: "/icons/motor.png" },
  { name: "LLP-Specific Compliance", icon: "/icons/motor.png" },
  { name: "NGO Related", icon: "/icons/motor.png" }
];

export default function CorporateSelectCategory() {
