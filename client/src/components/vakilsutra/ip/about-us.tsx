...
import { Phone, Mail, MapPin, Shield, Target, Users, CheckCircle2, FileCheck, Headphones, Handshake } from "lucide-react";

const expertiseAreas = [
  {
    icon: Shield,
    title: "IP Law Experts",
    description: "Our team of experienced lawyers specializes in intellectual property laws and regulations."
  },
  {
    icon: Target,
    title: "Case Management",
    description: "We handle your IP case with precision and dedication, ensuring the best possible outcome."
  },
  {
    icon: Users,
    title: "Client Support",
    description: "Our dedicated support team is always ready to assist you throughout your IP journey."
  }
];
...
const approachPoints = [
  {
    icon: CheckCircle2,
    title: "Transparency",
    description: "Clear communication and regular updates on your IP case progress"
  },
  {
    icon: FileCheck,
    title: "Efficiency",
  ...
  },
  {
    icon: Handshake,
    title: "Support",
    description: "Dedicated assistance throughout your IP protection journey"
  }
];

export default function IPAboutUs() {
  return (
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            At Vakilsutra, we are committed to safeguarding your intellectual property rights and ensuring your innovations are protected.
          </p>
        </motion.div>
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-16">
          ...
          >
            ...
            <p className="text-gray-600 leading-relaxed">
              To provide accessible, efficient, and effective IP protection solutions, ensuring your innovations and creative works are properly safeguarded.
            </p>
          </motion.div>
          <motion.div
            initial={{ opacity: 0, x: 20 }}
          ...
          >
            ...
            <p className="text-gray-600 leading-relaxed">
              To be the leading platform for IP protection, setting new standards in legal service delivery and client satisfaction.
            </p>
          </motion.div>
        </div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-600">ip@vakilsutra.com</p>
              </div>
            </div>
          </div>
        </motion.div>
