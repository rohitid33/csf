  ...
  return (
    <div className="container mx-auto px-2 sm:px-4 mt-8 md:mt-12">
      <ScrollArea className="w-full" style={{ WebkitOverflowScrolling: 'touch' }}>
        <div className="flex gap-4 sm:gap-6 pb-4 overflow-y-visible" style={{ scrollBehavior: 'smooth', willChange: 'transform' }}>
          {banners.map((banner, index) => (
            <motion.div
              ...
              className="relative group overflow-hidden rounded-2xl shadow-lg cursor-pointer min-w-[280px] sm:min-w-[300px] md:min-w-[400px] lg:min-w-[500px]"
            >
