...
const categories = [
  { name: "Trademark Services", icon: "/icons/trademark.png" },
  { name: "Copyright Services", icon: "/icons/copyright.png" },
  { name: "Patent Services", icon: "/icons/patent.png" },
  { name: "Design & Branding", icon: "/icons/design.png" }
];

export default function IPSelectCategory() {
