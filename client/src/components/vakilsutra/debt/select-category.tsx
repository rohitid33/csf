...
const categories = [
  { name: "Credit Card Debt", icon: "/icons/motor.png" },
  { name: "Personal Loans", icon: "/icons/motor.png" },
  { name: "Recovery Protection", icon: "/icons/motor.png" },
  { name: "Debt Consolidation", icon: "/icons/motor.png" },
  { name: "Legal Services", icon: "/icons/motor.png" },
  { name: "Business Debt", icon: "/icons/motor.png" }
];

export default function DebtSelectCategory() {
